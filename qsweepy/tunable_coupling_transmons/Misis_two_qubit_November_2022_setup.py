...
device_settings = {
                   'vna_address': 'TCPIP0::10.20.61.66::inst0::INSTR', # TCPIP0::10.20.61.94::inst0::INSTR  TCPIP0::10.20.61.68::inst0::INSTR
                   # 'rf_switch_address': '10.20.61.91',
                   'use_rf_switch': False,
                   'hdawg_address': 'hdawg-dev8250', #8250 8108
                   'sa_ro_address': 'TCPIP0::10.20.61.56::inst0::INSTR',
...
class hardware_setup():
    ...
    def open_devices(self):
        ...
        #self.q2x= awg_channel(self.hdawg, 6)  # coil control
    ...
    def set_pulsed_mode(self):
        ...
        self.hdawg.set_dig_trig1_source([1,1,4,1])#[6, 6, 4, 6]
        ...
        self.hdawg.set_dig_trig2_source([1,1, 5, 1])#[0, 0, 5, 0]
        ...
        self.ro_trg = awg_digital(self.hdawg, 4, delay_tolerance=20e-9)  # triggers readout card # Было 4
