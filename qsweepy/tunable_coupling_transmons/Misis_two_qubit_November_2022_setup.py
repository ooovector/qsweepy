...
device_settings = {
                   'vna_address': 'TCPIP0::10.20.61.94::inst0::INSTR', #ZVB
                   # 'rf_switch_address': '10.20.61.91',
                   'use_rf_switch': False,
                   'hdawg_address': 'hdawg-dev8108', #8250 8108
                   'sa_address': 'TCPIP0::10.20.61.56::inst0::INSTR',
                   'sa_ro_address': 'TCPIP0::10.20.61.37::inst0::INSTR',
                   'lo1_address': 'TCPIP0::10.20.61.50::inst0::INSTR',
                   'adc_timeout': 25,#10
...
class hardware_setup():
    ...
    def open_devices(self):
        ...
        self.bias_508 = instruments.Yokogawa_GS210(address='GPIB0::2::INSTR')
        self.bias_507 = instruments.Yokogawa_GS210(address='GPIB0::1::INSTR')
        ...
        # self.q2x= awg_channel(self.hdawg, 4)  # coil control
        #self.cz = awg_channel(self.hdawg, 3)  #7 coil control
        self.q1x = awg_channel(self.hdawg, 2)  # coil control
    ...
    def set_pulsed_mode(self):
        ...
        self.hdawg.set_dig_trig1_source([1,1,1,6])#[6, 6, 4, 6]
        ...
        self.hdawg.set_dig_trig2_source([1,1,1,7])#[0, 0, 5, 0]
        ...
        self.ro_trg = awg_digital(self.hdawg, 6, delay_tolerance=20e-9)  # triggers readout card # Было 4
    ...
    def setup_iq_channel_connections(self, exdir_db):
        ...
        self.iq_devices = {'iq_ro':  qsweepy.libraries.awg_iq_multi2.AWGIQMulti(awg=self.hdawg, sequencer_id=3,
                                                                                  lo=self.pna, exdir_db=exdir_db),
                           # 'iq_ex': qsweepy.libraries.awg_iq_multi2.AWGIQMulti(awg=self.hdawg, sequencer_id=1,
        ...
        self.fast_controls = {'q3z': awg_channel(self.hdawg, 0),
                              # 'q2x': awg_channel(self.hdawg, 4),
                              'q1x': awg_channel(self.hdawg, 2),
                              }  # coil control
