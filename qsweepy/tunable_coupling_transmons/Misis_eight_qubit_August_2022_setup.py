...
class hardware_setup():
    ...
    def open_devices(self):
        ...
        self.q1z = awg_channel(self.hdawg1, 0)
        self.q2z = awg_channel(self.hdawg1, 1)
        # self.q3z = awg_channel(self.hdawg1, 2)
        # self.q4z = awg_channel(self.hdawg1, 3)
        # self.q5z = awg_channel(self.hdawg1, 4)
        # self.q6z = awg_channel(self.hdawg1, 5)
        # self.q7z = awg_channel(self.hdawg1, 6)
        # self.q8z = awg_channel(self.hdawg1, 7)
        ...
        #
        self.c1z = awg_channel(self.awg_tek, 1) # coil control
        self.c2z = awg_channel(self.awg_tek, 2)
        self.c1z.set_offset(0)
        self.c2z.set_offset(0)
        #
        self.c3z = awg_channel(self.awg_tek, 3)  # coil control
        self.c4z = awg_channel(self.awg_tek, 4)  # coil control
        self.c3z.set_offset(0)
        self.c4z.set_offset(0)
        # #
        # self.c5z = awg_channel(self.hdawg1, 0)
        # self.c6z = awg_channel(self.hdawg1, 1)
        # self.c7z = awg_channel(self.hdawg1, 2)
        # self.c8z = awg_channel(self.hdawg1, 3)
        #
