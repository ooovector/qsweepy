...
pulsed_settings = {'lo1_power': 12,
                   ...
                   'lo1_freq': 3.3e9,
                   'pna_freq': 7.12e9, #7.09e9 7.258e9 7.2111e9 7.257e9 7.232e9 7.2275e9 7.1e9 7.195e9
...
class hardware_setup():
    ...
    def open_devices(self):
        ...
        self.q3z = awg_channel(self.hdawg, 1)  # coil control
    ...
    def set_pulsed_mode(self):
        ...
        self.hdawg.set_dig_trig1_source([6, 6, 4, 6])
        ...
        self.hdawg.set_dig_trig2_source([0, 0, 5, 0])
    ...
    def setup_iq_channel_connections(self, exdir_db):
        ...
        self.iq_devices['iq_ex'].ignore_calibration_drift = True

        self.fast_controls = {'q3z': awg_channel(self.hdawg, 1),
