...
class hardware_setup():
    ...
    def setup_iq_channel_connections(self, exdir_db):
        ...
        # self.iq_devices['iq_ex'].sa = self.sa_ro

        self.iq_devices['iq_ex2_12'].name = 'ex'
        self.iq_devices['iq_ex2_12'].calibration_switch_setter = lambda: None
        self.iq_devices['iq_ex2_12'].sa = self.sa_ro
