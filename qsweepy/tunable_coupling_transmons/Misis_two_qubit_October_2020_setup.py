...
class hardware_setup():
    ...
    def open_devices(self):
        ...
        self.q1x = awg_channel(self.hdawg, 0)
        self.q2x = awg_channel(self.hdawg, 2)
        self.q3x = awg_channel(self.hdawg, 3)

        self.qz2 = awg_channel(self.hdawg, 4)  # coil control
        self.cz = awg_channel(self.hdawg, 5)  # coil control
        self.qz1 = awg_channel(self.hdawg, 6)  # coil control
        self.qz3 = awg_channel(self.hdawg, 7)  # coil control
...
#            self.hdawg.set_waveform(waveform=[0] * global_num_points, channel=channel)
    ...
    def setup_iq_channel_connections(self, exdir_db):
        ...
        self.fast_controls = {
                              'q1x': qsweepy.libraries.awg_channel.awg_channel(self.hdawg, 0),
                              'q2x': qsweepy.libraries.awg_channel.awg_channel(self.hdawg, 2),
                              'q3x': qsweepy.libraries.awg_channel.awg_channel(self.hdawg, 3),

                              'qz2': qsweepy.libraries.awg_channel.awg_channel(self.hdawg, 4),
                              'cz': qsweepy.libraries.awg_channel.awg_channel(self.hdawg, 5),
                              'qz1': qsweepy.libraries.awg_channel.awg_channel(self.hdawg, 6),
                              'qz3': qsweepy.libraries.awg_channel.awg_channel(self.hdawg, 7)}  # coil control
