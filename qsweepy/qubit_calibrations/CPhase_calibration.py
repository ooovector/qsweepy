...
def CPhase_calibration(device, qubit_id, coupler_id, gate, amplitude, length, transition='01', phis=None, tail_length=0e-9, readout_delay=0e-9,
                    *extra_sweep_args, repeats=1, pulse_U=None, additional_metadata={}):
