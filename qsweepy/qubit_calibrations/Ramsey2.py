...
def Ramsey(device, qubit_id, transition='01', *extra_sweep_args, channel_amplitudes1=None, channel_amplitudes2=None, lengths=None,
           ...
           additional_references = {}, additional_metadata = {}, gauss = True , sort = 'best', ex_pre_pulse=None, comment = '',
           ex_post_pulse=None, ex_pulse1 = None, ex_pulse2 = None, samples=False, shots=False, dot_products=False, post_selection_flag=False,
           ro_channel = None):
    from .readout_pulse2 import get_uncalibrated_measurer
    ...
    if ro_channel is None:
        ...
        readout_pulse, measurer = get_uncalibrated_measurer(device, ro_channel, transition=transition, samples=samples,
                                                            shots=shots, dot_products=dot_products,
                                                            readouts_per_repetition=readouts_per_repetition)
        measurement_name = 'iq' + ro_channel
    if ex_pulse1 is None:
    ...
    class ParameterSetter:
        def __init__(self):
            ...
            if ex_pre_pulse is not None:
                self.prepare_seq.extend(ex_pre_pulse)
            ...
            if ex_post_pulse is not None:
                self.prepare_seq.extend(ex_post_pulse)
...
def Ramsey(device, qubit_id, transition='01', *extra_sweep_args, channel_amplitudes1=None, channel_amplitudes2=None, lengths=None,
           ...
           additional_references = {}, additional_metadata = {}, gauss = True , sort = 'best', ex_pre_pulse=None, comment = '',
           ex_post_pulse=None, ex_pulse1 = None, ex_pulse2 = None, samples=False, shots=False, dot_products=False, post_selection_flag=False,
           ro_channel = None,readout_offsets = []):
    from .readout_pulse2 import get_uncalibrated_measurer
    if post_selection_flag:
        readouts_per_repetition = 3
    else:
...
def Ramsey_prepulse(device, qubit_id, transition='01', pre_pulse_delays = None, channel_amplitudes1=None, channel_amplitudes2=None, lengths=None,
           target_freq_offset=None, readout_delay=0, delay_seq_generator=None, pre_pulse_gate=None, measurement_type='Ramsey_prepulse',
           additional_references = {}, additional_metadata = {}, gauss = True , sort = 'best', ex_pre_pulse=None,
           ex_pre_pulse2=None, ex_post_pulse=None, ex_post_pulse2=None, samples=False, shots=False, dot_products=False, post_selection_flag=False):
    from .readout_pulse2 import get_uncalibrated_measurer
    if post_selection_flag:
