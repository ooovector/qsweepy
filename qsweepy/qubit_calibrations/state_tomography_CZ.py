from qsweepy.libraries.multiqubit_tomography_CZ import *
...
class ProcessTomography(multiqubit_tomography):
    def __init__(self, device, qubit_ids, correspondence, pause_length=0, phase_1=0,
                 phase_2=0, phase_x=0, phase_3=0, phase_4=0, number_of_circles=1):
        ...
        super().__init__(device, reducer, ex_sequencers, readout_sequencer, device.pg, multi_qubit_observables,
                         ...
                         phase_4=phase_4, number_of_circles=number_of_circles)
