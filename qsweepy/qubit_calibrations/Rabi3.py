...
def Rabi_rect(device, qubit_id, channel_amplitudes, transition='01', lengths=None, *extra_sweep_args, tail_length=0,
              ...
              dot_products=False, post_selection_flag=False):
    """
    ...
    class ParameterSetter:
        def __init__(self):
            ...
            # if pre_pulse:
            #     self.prepare_seq.append(pre_pulse.get_pulse_sequence(0)[0])
            # if post_pulse:
            #     self.prepare_seq.append(post_pulse.get_pulse_sequence(0)[0])
...
def Rabi_rect_spin_locking(device, qubit_id, channel_amplitudes, transition='01', lengths=None, *extra_sweep_args, tail_length=0,
              readout_delay=0, pre_pulses=tuple(), repeats=1, measurement_type='Rabi_rect', samples=False,
              additional_metadata={}, comment='', shots=False, frequency_goodness_test=None,
              dot_products=False, post_selection_flag=False):
    """
