...
from qsweepy.libraries import interleaved_benchmarking5 as interleaved_benchmarking
...
def benchmarking_pi2_multi(device, qubit_ids, *params, interleaver=None, two_qubit_gate=None, max_pulses=None,
    ...
    for qubit_id in qubit_ids:
        ...
        clifford_group  = clifford.generate_group2(HZ)
    ...
    gates_dataset = create_gates_dataset(device, clifford_group)
