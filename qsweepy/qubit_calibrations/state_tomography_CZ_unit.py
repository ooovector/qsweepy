from qsweepy.libraries.multiqubit_tomography_CZunit import *
...
class ProcessTomography(multiqubit_tomography):
    def __init__(self, device, qubit_ids, correspondence, pause_length=0, phase_1=0,
                 phase_2=0, phase_x=0, phase_3=0, phase_4=0, virtual_phase1=0, virtual_phase2=0,
                 number_of_circles=1, sign=1, amplitude=None):
        ...
        super().__init__(device, reducer, ex_sequencers, readout_sequencer, device.pg, multi_qubit_observables,
                         ...
                         interleavers=HZ_group, phase_1=phase_1, phase_2=phase_2, phase_x=phase_x, phase_3=phase_3,
                         phase_4=phase_4, virtual_phase1=virtual_phase1, virtual_phase2=virtual_phase2,
                         number_of_circles=number_of_circles, sign=sign, amplitude=amplitude)
