...
class single_shot_readout:
	...
	"""
	def __init__(self, adc, prepare_seqs, ro_seq, pulse_generator, ro_delay_seq = None, adc_measurement_name='Voltage'):
		self.adc = adc
		self.ro_seq = ro_seq
		...
		#self.cutoff_start = 0
		self.readout_classifier = readout_classifier.binary_linear_classifier()
