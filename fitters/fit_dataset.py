...
def fit_dataset_1d(source_measurement, dataset_name, fitter, time_parameter_id=-1, sweep_parameter_ids=[]):
	...
	# create fit dataset
	fit_dataset = data_structures.measurement_dataset(data=fit_unsorted, parameters=[data_structures.measurement_parameter(**p.__dict__) for p in dataset.parameters])
