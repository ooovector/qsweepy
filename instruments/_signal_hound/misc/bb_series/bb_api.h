...
// Convenience function for bbGetIQ, pass parameters directly, no struct
BB_API bbStatus bbGetIQUnpacked(int device, float *iqData, int iqCount,
                                int *triggers, int triggerCount, int purge, 
                                int *dataRemaining, int *sampleLoss, 
                                int *sec, int *nano);
